...
import { RecruitmentStatus } from '../../generated/prisma/client';
...
export class RecruitmentService {
  ...
  async remove(uuid: string) {
    const deleted = await this.db.recruitment.delete({ where: { uuid } });
    if (!deleted) throw new NotFoundException('Recruitment not found');
    return deleted;
  }
