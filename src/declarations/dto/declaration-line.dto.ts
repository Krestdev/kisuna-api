import { IsNumber, IsBoolean, IsUUID, IsArray, ValidateNested, IsOptional } from 'class-validator';
import { ApiProperty } from '@nestjs/swagger';
import { Type } from 'class-transformer';

export class DeclarationEarningItemDto {
...
export class CreateDeclarationLineDto {
  @ApiProperty({ example: '123e4567-e89b-12d3-a456-426614174001', description: 'Employee UUID' })
  @IsUUID()
  employeeId: string;

  @ApiProperty({ example: '123e4567-e89b-12d3-a456-426614174002', description: 'Contract UUID (optional, will use active contract if not provided)', required: false })
  @IsOptional()
  @IsUUID()
  contractId?: string;
  ...
  @ApiProperty({ example: true, description: 'Is base salary subject to social contributions?' })
  @IsBoolean()
  ...
  @ApiProperty({ 
    ...
    example: [
      { earningItemId: '123e4567-e89b-12d3-a456-426614174003', amount: 50000, taxable: true, cotisable: false }
    ],
