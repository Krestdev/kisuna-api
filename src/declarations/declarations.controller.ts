...
export class DeclarationsController {
  ...
  // EarningItem routes
  @Post('earning-items')
  @ApiOperation({ summary: 'Create earning item', description: 'Create a new earning item (salary component) for a company' })
  @ApiResponse({ status: 201, description: 'Earning item created successfully' })
  ...
  @Get('earning-items')
  @ApiOperation({ summary: 'Get all earning items', description: 'Retrieve earning items filtered by company, category, or active status' })
  @ApiQuery({ name: 'companyId', required: true, description: 'Company UUID' })
  @ApiQuery({ name: 'category', required: false, enum: EarningCategory, description: 'Filter by earning category' })
  ...
  @ApiOperation({ summary: 'Get earning item by ID', description: 'Retrieve a specific earning item' })
  ...
  @ApiOperation({ summary: 'Update earning item', description: 'Update an existing earning item' })
  @ApiParam({ name: 'uuid', description: 'Earning item UUID' })
  @ApiResponse({ status: 200, description: 'Earning item updated successfully' })
  @ApiResponse({ status: 404, description: 'Earning item not found' })
  updateEarningItem(@Param('uuid') uuid: string, @Body() dto: UpdateEarningItemDto) {
    return this.service.updateEarningItem(uuid, dto);
  }

  @Delete('earning-items/:uuid')
  @ApiOperation({ summary: 'Delete earning item', description: 'Delete an earning item' })
  @ApiParam({ name: 'uuid', description: 'Earning item UUID' })
  @ApiResponse({ status: 200, description: 'Earning item deleted successfully' })
  @ApiResponse({ status: 404, description: 'Earning item not found' })
  ...
  // Declaration routes
  @Post('declarations')
  @ApiOperation({ summary: 'Create declaration', description: 'Create a new payroll declaration for a period' })
  ...
  @Get('declarations')
  @ApiOperation({ summary: 'Get all declarations', description: 'Retrieve declarations filtered by company, type, or status' })
  ...
  @ApiQuery({ name: 'status', required: false, enum: DeclarationStatus, description: 'Declaration status' })
  ...
  @ApiOperation({ summary: 'Get declaration by ID', description: 'Retrieve a specific declaration with all lines and earnings' })
  ...
  @ApiOperation({ summary: 'Update declaration', description: 'Update declaration details or status' })
  @ApiParam({ name: 'uuid', description: 'Declaration UUID' })
  @ApiResponse({ status: 200, description: 'Declaration updated successfully' })
  @ApiResponse({ status: 404, description: 'Declaration not found' })
  updateDeclaration(@Param('uuid') uuid: string, @Body() dto: UpdateDeclarationDto) {
    return this.service.updateDeclaration(uuid, dto);
  }

  @Delete('declarations/:uuid')
  @ApiOperation({ summary: 'Delete declaration', description: 'Delete a declaration and all associated lines' })
  @ApiParam({ name: 'uuid', description: 'Declaration UUID' })
  ...
  @ApiOperation({ summary: 'Create declaration lines', description: 'Bulk create declaration lines for employees' })
  @ApiParam({ name: 'declarationId', description: 'Declaration UUID' })
  @ApiResponse({ status: 201, description: 'Declaration lines created successfully' })
  @ApiResponse({ status: 404, description: 'Declaration not found' })
  ...
  @ApiOperation({ summary: 'Get declaration lines', description: 'Retrieve all lines for a declaration' })
  @ApiParam({ name: 'declarationId', description: 'Declaration UUID' })
  ...
  @ApiOperation({ summary: 'Get declaration line by ID', description: 'Retrieve a specific declaration line with earnings' })
  @ApiParam({ name: 'declarationId', description: 'Declaration UUID' })
  ...
  @ApiOperation({ summary: 'Update declaration line', description: 'Update a declaration line' })
  @ApiParam({ name: 'declarationId', description: 'Declaration UUID' })
  @ApiParam({ name: 'lineId', description: 'Declaration line UUID' })
  @ApiResponse({ status: 200, description: 'Declaration line updated successfully' })
  @ApiResponse({ status: 404, description: 'Declaration line not found' })
  ...
  @ApiOperation({ summary: 'Delete declaration line', description: 'Delete a declaration line and associated earnings' })
  @ApiParam({ name: 'declarationId', description: 'Declaration UUID' })
  @ApiParam({ name: 'lineId', description: 'Declaration line UUID' })
  @ApiResponse({ status: 200, description: 'Declaration line deleted successfully' })
  @ApiResponse({ status: 404, description: 'Declaration line not found' })
  ...
  @ApiOperation({ summary: 'Add earning to line', description: 'Add an earning entry to a declaration line' })
  @ApiParam({ name: 'lineId', description: 'Declaration line UUID' })
  ...
  @ApiOperation({ summary: 'Update earning', description: 'Update an earning entry amount' })
  @ApiParam({ name: 'lineId', description: 'Declaration line UUID' })
  ...
  @ApiOperation({ summary: 'Delete earning', description: 'Remove an earning entry from a declaration line' })
  @ApiParam({ name: 'lineId', description: 'Declaration line UUID' })
  @ApiParam({ name: 'earningId', description: 'Declaration earning UUID' })
